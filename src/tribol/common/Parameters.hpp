...
enum PolyInteg
{
  ...
  MULTI_POINT,   ///! Multi-point integration over a triangle decomposition of the overlap
  NUM_INTEG_RULES
};
...
struct Parameters {
  ...
  RealT residual_gap = 0.0;                  ///! Nonnegative gap constraint; positive values enforce separation
};
