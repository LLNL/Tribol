...
#ifndef TYPESTRIBOL_SIMPLE_H
#define TYPESTRIBOL_SIMPLE_H
...
struct s_TRIBOL_SIMPLE_SHROUD_capsule_data {
    void *addr;     /* address of C++ memory */
    int idtor;      /* index of destructor */
};
typedef struct s_TRIBOL_SIMPLE_SHROUD_capsule_data TRIBOL_SIMPLE_SHROUD_capsule_data;

// helper array_context
struct s_TRIBOL_SIMPLE_SHROUD_array {
    TRIBOL_SIMPLE_SHROUD_capsule_data cxx;      /* address of C++ memory */
    union {
        const void * base;
        const char * ccharp;
    } addr;
...
typedef struct s_TRIBOL_SIMPLE_SHROUD_array TRIBOL_SIMPLE_SHROUD_array;
