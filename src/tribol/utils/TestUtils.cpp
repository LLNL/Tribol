...
{
   // TODO fix this check to support triangles
   SLIC_ERROR_IF(this->numNodesPerFace != 4, "simpleTribolSetupAndUpdate: number of nodes " <<
                 "per face not equal to 4.");
                                    ...
                                    TestControlParameters& params )
{
   ...
   // TODO fix this check
   SLIC_ERROR_IF(this->numNodesPerFace != 4, "tribolSetupAndUpdate: number of nodes per face not equal to 4.");
