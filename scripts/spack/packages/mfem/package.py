...
class Mfem(Package, CudaPackage, ROCmPackage):
    ...
    #TRIBOL EDIT BEGIN
    patch('fix_name_mangling.patch', when='%xl')
    #TRIBOL EDIT END
    ...
    def configure(self, spec, prefix):
        ...
        if '+cuda' in spec:
            xcompiler = '-Xcompiler='
            # TRIBOL EDIT BEGIN - Xlinker fix 1/3 - better way? upstream?
            xlinker = '-Xlinker '
            # TRIBOL EDIT END
        ...
        def ld_flags_from_library_list(libs_list):
            # TRIBOL EDIT BEGIN - Xlinker fix 2/3
        ...
        def ld_flags_from_dirs(pkg_dirs_list, pkg_libs_list):
            # TRIBOL EDIT BEGIN - Xlinker fix 3/3
